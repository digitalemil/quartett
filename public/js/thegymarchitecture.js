...
function TheGymArchitecture() {
	...
	let crp= new MicroserviceThing("images/microservice.png", "yugabyteDB", "Persister", sx+1.5*dx, 0, s, 120, 120);
	let cr= new MicroserviceThing("images/yugabyte.png", "", "yugabyteDB", sx+3.5*dx, 0, s, 120, 120);
